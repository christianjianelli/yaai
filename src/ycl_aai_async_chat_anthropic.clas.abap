CLASS ycl_aai_async_chat_anthropic DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS on_message_send FOR EVENT on_message_send OF ycl_aai_anthropic.

    METHODS on_response_received FOR EVENT on_response_received OF ycl_aai_anthropic.

    METHODS on_message_failed FOR EVENT on_message_failed OF ycl_aai_anthropic
      IMPORTING
        error_text.

    METHODS on_chat_is_blocked FOR EVENT on_chat_is_blocked OF ycl_aai_anthropic.

    METHODS on_tool_call FOR EVENT on_tool_call OF yif_aai_func_call_anthropic
      IMPORTING
        class_name
        method_name.

    METHODS on_tool_call_response FOR EVENT on_tool_call_response OF yif_aai_func_call_anthropic
      IMPORTING
        tool_response.

    METHODS on_tool_call_error FOR EVENT on_tool_call_error OF yif_aai_func_call_anthropic
      IMPORTING
        error_text.
...
CLASS ycl_aai_async_chat_anthropic IMPLEMENTATION.
