INTERFACE yif_aai_google
  ...
  TYPES: BEGIN OF ty_options_s,
         ...
         BEGIN OF ty_google_generate_request_s,
           model   TYPE string,
           prompt  TYPE string,
           system  TYPE string,
         ...
         BEGIN OF ty_google_chat_request_s,
           model    TYPE string,
           stream   TYPE abap_bool,
           messages TYPE ty_chat_messages_t,
           tools    TYPE /ui2/cl_json=>json,
           options  TYPE ty_options_s,
         END OF ty_google_chat_request_s,
         ...
         BEGIN OF ty_google_chat_response_s,
           model   TYPE string,
           message TYPE ty_chat_message_s,
         END OF ty_google_chat_response_s.

  TYPES: BEGIN OF ty_google_embed_request_s,
           model TYPE string,
           input TYPE string,
         END OF ty_google_embed_request_s.

  TYPES: ty_embedding_t TYPE STANDARD TABLE OF f WITH DEFAULT KEY.

  TYPES: BEGIN OF ty_google_embed_response_s,
           model             TYPE string,
         ...
         END OF ty_google_embed_response_s.
  ...
  METHODS embed
    ...
    EXPORTING
      e_s_response TYPE ty_google_embed_response_s.
